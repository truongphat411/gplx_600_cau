...
class QuestionControls extends StatelessWidget {
                    ...
                    ? ControlButton(
                        ...
                        onTap: () {
                          context.read<QuestionsActionBloc>().add(
                                const QuestionsActionEvent.previousPage(),
                              );
                        },
                      )
              ...
              Center(
                child: currentPage < questions.length - 1
                    ? ControlButton(
                        ...
                        onTap: () {
                          context.read<QuestionsActionBloc>().add(
                                const QuestionsActionEvent.nextPage(),
                              );
                        },
                      )
                    : const SizedBox.shrink(),
  ...
  Widget build(BuildContext context) {
    final appColors = Theme.of(context).appColors;
    return BlocBuilder<QuestionsActionBloc, QuestionsActionState>(
                    ...
                    child: Container(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final stt = questionType == QuestionTypeEnum.test
                              ? index + 1
